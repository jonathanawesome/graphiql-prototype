import { Caret } from '@graphiql-v2-prototype/graphiql-plugin-pane-pathfinder/src/icons';
import { SeparatorRound, styled } from '@graphiql-v2-prototype/graphiql-ui-library';
